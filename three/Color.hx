...
@:forward
abstract Color(CColor){

	public inline function new(?hex:Int){
		this = new CColor();
		this.setHex(hex);
	}

	@:from static inline function fromInt(hex:Int):Color{
		return new Color(hex);
	}

}

@:native("THREE.Color") private extern class CColor {
